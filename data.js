...
var fourthMenuItems = [{ name: "Courses" }, { name: "Get Certified" }];
...
var mobileMenuItems = {
  ".first-mobile-hidden-menu": firstMenuItems,
  ".second-mobile-hidden-menu": secondMenuItems,
  ".third-mobile-hidden-menu": thirdMenuItems,
  ".fourth-mobile-hidden-menu": fourthMenuItems,
  ".fifth-mobile-hidden-menu": fifthMenuItems,
  ".sixth-mobile-hidden-menu": sixthMenuItems,
};
